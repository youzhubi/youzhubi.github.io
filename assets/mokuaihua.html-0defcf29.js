import{_ as n,p as s,q as a,Z as e}from"./framework-053dfde5.js";const p={},t=e(`<h2 id="模块化" tabindex="-1"><a class="header-anchor" href="#模块化" aria-hidden="true">#</a> 模块化</h2><p>早期的网页中，是没有一个实质的模块规范的</p><p>​ 我们实现模块化的方式，就是最原始的通过script标签来引入多个js文件</p><p>​ 问题：</p><p>​ 1.无法选择要引入模块的哪些内容</p><p>​ 2.在复杂的模块场景下非常容易出错</p><p>​ 。。。。。。</p><p>​ 于是，我们就急需在js中引入一个模块化的解决方案</p><p>​ 在node中，默认支持的模块化规范叫做CommonJS,</p><p>​ 在CommonJS中，一个js文件就是一个模块</p><h3 id="commonjs规范" tabindex="-1"><a class="header-anchor" href="#commonjs规范" aria-hidden="true">#</a> <strong>CommonJS规范</strong></h3><p>引入模块</p><ul><li><p>使用require(&quot;模块路径&quot;)函数来引入模块</p><ul><li><p>引入自定义模块时</p><p>模块名要以./或../开头</p></li></ul></li></ul><p>m1.js</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token comment">// let a = 10</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">const</span> m1 <span class="token operator">=</span> <span class="token function">require</span><span class="token punctuation">(</span><span class="token string">&quot;./m1.js&quot;</span><span class="token punctuation">)</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>默认情况下，Node.js会将以下内容视为CommonJS模块：</strong></p><ol><li>使用.cjs为扩展名的文件</li><li>当前的package.json的type属性为commonjs时，扩展名为.js的文件</li><li>当前的package.json不包含type属性时，扩展名为.js的文件</li><li>文件的扩展名是mjs、cjs、json、node、js以外的值时（type不是module时）</li></ol><h3 id="文件夹作为模块" tabindex="-1"><a class="header-anchor" href="#文件夹作为模块" aria-hidden="true">#</a> 文件夹作为模块</h3><p>当我们使用一个文件夹作为模块时，文件夹中必须有一个模块的主文件。如果文件夹中含有<code>package.json</code>文件且文件中设置<code>main</code>属性，则<code>main</code>属性指定的文件会成为主文件，导入模块时就是导入该文件。</p><p>如果没有<code>package.json</code>，<strong>则node会按照<code>index.js</code>、<code>index.node</code>的顺序寻找主文件。</strong></p><p>主文件👇（index.js） 假设一个文件夹（hello）包含四个文件</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token comment">//引入其他三个模块</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="commonjs原理" tabindex="-1"><a class="header-anchor" href="#commonjs原理" aria-hidden="true">#</a> CommonJS原理</h3><p>每一个CommonJS模块在执行时，外层都会被套上一个函数：</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token comment">//(function(exports, require, module, __filename, __dirname) {</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>特点</strong></p><ol><li>ES模块基于文件路径解析</li><li>支持加载内置模块</li><li>相对/绝对路径均可</li><li>没有默认扩展名</li><li>文件夹模块没有主文件</li><li>支持node_modules加载包</li></ol>`,48),o=[t];function c(l,i){return s(),a("div",null,o)}const r=n(p,[["render",c],["__file","mokuaihua.html.vue"]]);export{r as default};
